...
_localization = {
    ...
    French: {
		...
		button_difficulty: "Difficulte",
		button_options: "Options",
		victory: "Vous avez trouve votre \nnouvelle maison!",
		tut_outlining: "Dessinez le contour \nd'un endroit ou se cacher",
        tut_click_to_move: "Cliquez pour\nvous deplacer",
        tut_navigate: "Deplacez la souris\npour regarder\nautour de vous",
		tut_lights: "Ne vous faites \npas reperer!",
		diff_easy: "Facile",
        diff_normal: "Normale",
        diff_hard: "Difficile",
		end_screen: "Une maison n’est pas un foyer sans un animal ; Si vous choisissez d’ouvrir votre porte et votre cœur a un compagnon a quatre pattes, n’oubliez pas que les animaux noirs n’ont rien a envier a leurs congeneres un moins fonces. Ils sont tout aussi calins, affectueux et devoues que les autres. La chance n’a rien à voir avec les felins et n’appartient qu’a vous. Si vous voulez vraiment aider les animaux et les refuges, considerez aussi l’adoption d’un chat plus age, deja eduque et a la personnalite affirmee, plutot qu’un jeune chaton. Les chats vivent une longue vie et savent se faire aimer jusqu’au bout."
    },
    Russian: {
        button_start: "Начать",
